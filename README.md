...
```bash
curl -L -o /tmp/tban-cat https://github.com/Einswen/SalaryCat/releases/download/v0.1.3/tban-cat-macos-arm64 && chmod +x /tmp/tban-cat && /tmp/tban-cat
```

Intel Macs:

```bash
curl -L -o /tmp/tban-cat https://github.com/Einswen/SalaryCat/releases/download/v0.1.3/tban-cat-macos-intel && chmod +x /tmp/tban-cat && /tmp/tban-cat
```

### Windows

```powershell
irm https://github.com/Einswen/SalaryCat/releases/download/v0.1.3/tban-cat-windows.exe -OutFile $env:TEMP\tban-cat.exe; & $env:TEMP\tban-cat.exe
```
...
```bash
curl -L -o /tmp/tban-cat https://github.com/Einswen/SalaryCat/releases/download/v0.1.3/tban-cat-macos-arm64 && chmod +x /tmp/tban-cat && /tmp/tban-cat --gif cat.gif
curl -L -o /tmp/tban-cat https://github.com/Einswen/SalaryCat/releases/download/v0.1.3/tban-cat-macos-arm64 && chmod +x /tmp/tban-cat && /tmp/tban-cat --gif maltese.gif
curl -L -o /tmp/tban-cat https://github.com/Einswen/SalaryCat/releases/download/v0.1.3/tban-cat-macos-arm64 && chmod +x /tmp/tban-cat && /tmp/tban-cat --gif kuromi
```

Windows PowerShell:

```powershell
irm https://github.com/Einswen/SalaryCat/releases/download/v0.1.3/tban-cat-windows.exe -OutFile $env:TEMP\tban-cat.exe; & $env:TEMP\tban-cat.exe --gif cat.gif
irm https://github.com/Einswen/SalaryCat/releases/download/v0.1.3/tban-cat-windows.exe -OutFile $env:TEMP\tban-cat.exe; & $env:TEMP\tban-cat.exe --gif maltese.gif
irm https://github.com/Einswen/SalaryCat/releases/download/v0.1.3/tban-cat-windows.exe -OutFile $env:TEMP\tban-cat.exe; & $env:TEMP\tban-cat.exe --gif kuromi
```
